...
int main(int argc, char* argv[]){
    ...
    if ((!mem->testigo && mem->contador_pag_adm_pendientes == 1) ||
        ...
        long secondsEscritorio = timePruebaEscritorFin.tv_sec - timePruebaEscritorInicio.tv_sec;
        long usecEscritor = secondsEscritorio*1000000 + timePruebaEscritorFin.tv_usec - timePruebaEscritorInicio.tv_usec;

        fprintf(fichero_salida, "%d,Pagos,%ld,%ld,%ld\n", mi_id, microsSC, microsSalida, usecEscritor);
